...
export default function WorkTogether() {
  return (
    <section
      ...
      style={{ marginBottom: "60px", background: "#f0f4f9", padding: "30px" }}
    >
      <div className="container">
        <h2 className="section-title">Let’s Work Together</h2>
        <p className="section-description">
          If you’re ready to take your research and editorial processes to the
        ...
        <ul className="contact-list" style={{ display: "flex", gap: "40px" }}>
          <li>
            ...
            <a
              href="mailto:success@manuscriptedit.com"
