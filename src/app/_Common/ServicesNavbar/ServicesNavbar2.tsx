...
const ServicesNavbar2: React.FC = () => {
  useEffect(() => {
    const test = () => {
      ...
      if (activeItemNewAnim) {
        ...
        const itemPosNewAnimLeft = (activeItemNewAnim as HTMLElement).offsetLeft;
  ...
  return (
    <nav className="navbar navbar-expand-custom navbar-mainbg" style={{ paddingBottom: "0px",paddingTop: '0px'}}>
        ...
        <ul className="navbar-nav ml-auto">
          ...
          <li className="nav-item">
            <a className="nav-link" href="javascript:void(0);">
              ...
              Editing & Language Services</a>
          </li>
          <li className="nav-item active">
            <a className="nav-link" href="javascript:void(0);">
              {/* <i className="far fa-address-book"></i> */}
              Publication Support</a>
          </li>
          <li className="nav-item">
            <a className="nav-link" href="javascript:void(0);">
              {/* <i className="far fa-clone"></i> */}
             Scientific / Academic Writing</a>
          </li>
          <li className="nav-item">
            <a className="nav-link" href="javascript:void(0);">
              {/* <i className="far fa-calendar-alt"></i> */}
              Research & Statistical Analysis</a>
          </li>
          <li className="nav-item">
            <a className="nav-link" href="javascript:void(0);">
              {/* <i className="far fa-chart-bar"></i> */}
              Thesis & Dissertation Services</a>
          </li>
          <li className="nav-item">
            <a className="nav-link" href="javascript:void(0);">
