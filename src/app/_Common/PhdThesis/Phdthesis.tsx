  ...
  return (
    <>
      <div className="GetEveryHead">
        ...
        >
          Avail Tailored PhD Subscription Services
        </h2>
        <p style={{ textAlign: "center" }}>
          Overcome your PhD hurdles with ease. From initial topic selection to
          postdoctoral applications, ManuscriptEdit delivers precise,
          expert-driven solutions tailored to each phase of your PhD.
        </p>
      </div>

      <div
        className="container-fluid GetEveryHead"
        style={{ marginTop: "23px", marginBottom: "30px" }}
      >
        <div
          className="row"
        ...
        >
          ...
          <div
            ...
            style={{ display: activeTab === "firstTab" ? "block" : "none" }}
          >
            <div className="table-responsive">
              <table className="table table-bordered">
                <thead>
                  <tr>
                    <th scope="col" style={{ color: "#5161ce" }}>
                    ...
                    <th scope="col" style={{ color: "#5161ce" }}>
                      Free Services with Subscription
                    </th>
                    <th scope="col" style={{ color: "#5161ce" }}>
                      Discounted Services
                    </th>
                ...
                <tbody>
                  ...
                  <tr>
                    <td scope="row">
                      Webinars and workshops on research trends and application
                      processes
                    </td>
                    <td>Yes</td>
              ...
              <div className="donate-btn-header1" style={{ textAlign: "end" }}>
                <span>
                  <Link href="/ContactUs" className="dtbtn">
                    Contact Us
                  </Link>{" "}
                  <Link
                    href="https://salesiq.zohopublic.com/signaturesupport.ls?widgetcode=siq8d693704fe8ef7898f93fd220287834145838a6814d3df994dcd8741f14019a3"
                    className="dtbtn"
                  >
          ...
          <div
            id="secondTab"
            className="tabcontent"
            style={{ display: activeTab === "secondTab" ? "block" : "none" }}
          >
            <div className="table-responsive">
              <table className="table table-bordered">
                <thead>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>Yes</td>
                    <td>
                      Access to webinars on research methodologies data analysis
                    </td>
                  ...
                  <tr>
                    <td scope="row">
                      Writing assistance for scholarship proposals and grant
                      applications
                    </td>
                    <td>Yes</td>
                  ...
                  <tr>
                    <td scope="row">
                      Research coursework support and test preparation
                    </td>
                    <td>Yes</td>
                    <td>NA</td>
                    <td>NA</td>
                  ...
                  <tr>
                    <td scope="row">
                      Assistance with preparing and presenting synopsis seminar
                      and report
                    </td>
                    <td>Yes</td>
                    <td>NA</td>
          ...
          <div
            id="thirdTab"
            className="tabcontent"
            style={{ display: activeTab === "thirdTab" ? "block" : "none" }}
          >
            <div className="table-responsive">
              <table className="table table-bordered">
                <thead>
                ...
                <tbody>
                  <tr>
                    <td scope="row">
                      Statistical analysis using SPSS/Data analysis
                    </td>
                    <td>Yes</td>
          ...
          <div
            id="FourthTab"
            className="tabcontent"
            style={{ display: activeTab === "FourthTab" ? "block" : "none" }}
          >
            <div className="table-responsive">
              <table className="table table-bordered">
                <thead>
                ...
                <tbody>
                  <tr>
                    <td scope="row">
                      Journal Manuscript framework preparation
                    </td>
                    <td>Yes</td>
                  ...
                  <tr>
                    <td scope="row">
                      Dedicated expert as a mentor for final review
                    </td>
                    <td>Yes</td>
                    <td>NA</td>
                    <td>Resume making</td>
                  ...
                  <tr>
                    <td scope="row">
                      Workshop on manuscript submission and publication process
                    </td>
                    <td>Yes</td>
                    <td>NA</td>
