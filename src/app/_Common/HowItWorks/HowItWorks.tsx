    ...
    <section className="how-it-works">
      <div className="container">
        <div className="row" style={{ alignItems: "center" }}>
          ...
          <div className="col-lg-6">
            <p>
              We simplify the process of enhancing your research work. From
              submitting your order to receiving the polished manuscript, our
              expert team ensures precision and quality at every step. Let us
              help you achieve publication success with ease.
            </p>
          </div>
        </div>
        ...
        <div className="row">
          {steps.map((step) => (
            <div className="col-lg-3 col-md-6 mb-4" key={step.id}>
              <div className="step text-center p-4" style={{ height: "15rem" }}>
