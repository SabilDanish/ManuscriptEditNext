    ...
    <div className="container webContainer">
      <div className="row WebRow">
        <div className="col-lg-7">
          <img
            className="ImgWeb"
            src="/images/GlobalPartners/Webinar.jpg"
            alt="Webinar"
          />

          <div className="card-body" style={{ background: "white" }}>
            <p className="card-text">
              Name : Research Planning, Designing and Writing Research Paper for
              High Impact Journal Publication <br />
          ...
          <div>
            <h3 style={{ color: "#5161ce" }}>* Note to candidates: </h3>
            <p>
              Those who have already registered, kindly login and book your slot
              in your dashboard. Those who have not registered and new to the
              website, kindly register to book your slot for the webinar.
            </p>
          </div>
        </div>
            ...
            <form className="LoginForm">
              ...
              <div className="form-group">
                ...
                >
                  ...
                  <span className="webspan">Sign Up</span>
                </p>
              </div>
            </form>
          ) : (
            <form>
              <h5 className="headingweb5">
                Register for the Free Webinar & Q&A Session
              </h5>
              <p className="paragraphweb">
                Get a free ManuscriptEdit account after registration
              </p>
