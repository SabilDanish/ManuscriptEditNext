  ...
  return (
    <div className="container" style={{marginBottom:"60px"}}>
      ...
      <p>
        ...
        this agreement. The &quot;Client&quot; agrees that this Agreement is
        enforceable like any written negotiated agreement signed by the parties
        to this agreement.
      </p>
      <h3>Definitions</h3>
      <p>
      ...
      Product information brochures, Operating manuals, other promotional and
      educational material, Website content &amp; design.
      ...
      English proofreading, checking the manuscript&#39;s English language for
      ...
      errors, evaluation of flow, presentation, and sentence structure, phrases
      and expert suggestions, improve word choice as well as adjusting the
      ...
      editing research proposals, journal selection, journal submission, writing
      ...
      rephrasing, revising sentence structure, checking for consistency, proper
      usage, and typographical errors, evaluation of flow, presentation, and
      sentence structure, phrases and expert suggestions, improve word choice as
      well as adjusting the style, camera-ready formatting, target journal
      ...
      electronic transfer through a secure online payment gateway provided by
      ...
      client wishes to express), or contents that are difficult to decipher by
      ...
      the documents submitted to it by the client; or (ii) guarantee the
      ...
      be deemed &quot;closed&quot;. Further, repeated rejections by journals on
      ...
      address the comments and instead decides to submit the article to a
      different journal, an additional administrative fee of $175 will be
      applied. This covers the expert’s fee to proceed with the next journal as
      considerable effort and time is invested for preparing the article. The
      client may avail this chargeable resubmission option for up to two
      subsequent journals. However, beyond that, no further resubmission
      requests will be accommodated, and the order will be considered
      &quot;Closed&quot;.
      ...
      <br/><strong>Exclusion from Upgradation:</strong> Exclusion from Upgradation:
      ...
      <br/><strong>Reference to Supplementary Price List:</strong> A supplementary
      ...
      <br/><strong>Acknowledgment of Client Responsiveness Expectations:</strong> The
      ...
      <br/><strong>Reinitiation of Suspended Order:</strong> To reinitiate a
      ...
      claims whatsoever shall be settled by arbitration in accordance with
      Arbitration &amp; Conciliation Act 1996.The arbitration shall be held in
      Bhubaneswar, Odisha, INDIA. The language of arbitration shall be English
      ...
      any material from this site, including code and software. You may download
      material from this site for your personal, non-commercial use only,
      provided you keep intact all copyright and other proprietary notices. By
      using this website, the client agrees to be bound by all of the terms and
      ...
      notice, provided that any modification, amendment, or update to the Terms
      of Service will only be effective against the Client for purchases
      ...
      from delays in providing the requisite information or feedback from the
      client&#39;s end or the back-and-forth exchange of emails. Any delay in
      payment beyond the agreed-upon date may incur a fine as per the guidelines
      specified in point &#39;am&#39;.
      ...
      success of their submissions and increase the likelihood of their work
      being recognized and appreciated by the academic community.
