        ...
        <div className={styles.benefitsBox}>
          ...
          <section className={styles.benefitsWrapper}>
            ...
            <ul className={styles.benefitsList}>
                  ...
                  <li>
                    ✅ <strong>Experienced Researchers:</strong> Advanced
                    editing to meet high-impact journal standards.
                  </li>
                  <li>
                    ✅ <strong>Institutions & Universities:</strong> Bulk
                    editing services tailored to the needs of faculty and
                    students.
                  </li>
                </ul>
          </section>
