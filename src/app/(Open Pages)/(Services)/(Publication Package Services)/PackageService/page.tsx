              ...
              <div className="pricing_single-box st-grid-price">
                <div className="pricing-head">
                  ...
                  <div className="pricing_tk">
                    <h2>
                      <span className="dollar">$</span>2134 <span>30 Days</span>
                    </h2>
                  </div>
                </div>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="pricing_single-box st-grid-price">
                <div className="pricing-head">
                  ...
                  <div className="pricing_tk">
                    <h2>
                      <span className="dollar">$</span>1534<span> 20 Days</span>
                    </h2>
                  </div>
                </div>
                <div className="pricing_body">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="pricing_single-box st-grid-price">
                <div className="pricing-head">
                  ...
                  <div className="pricing_tk">
                    <h2>
                      <span className="dollar">$</span>1134<span> 15 Days</span>
                    </h2>
                  </div>
                </div>
                <div className="pricing_body">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="pricing_single-box st-grid-price">
                <div className="pricing-head">
                  ...
                  <div className="pricing_tk">
                    <h2>
                      <span className="dollar">$</span>867<span> 10 Days</span>
                    </h2>
                  </div>
                </div>
                <div className="pricing_body">
