...
export default function RootLayout({
  ...
  useEffect(() => {
    ...
    const widgetCode =
      "48b75dd3dada5e99bd73a91fe334bbb18644220ee9201f866679581b19cc5384";
  ...
  return (
    <html lang="en">
      ...
      <head>
        ...
        <Script
          type="text/javascript"
          src="/js/facebookPixelCodeOne.js"
          strategy="lazyOnload"
        />
        <Script
          type="text/javascript"
          src="/js/facebookPixelCodeTwo.js"
          strategy="lazyOnload"
        />
        <Script
          type="text/javascript"
          src="/js/GtagManager.js"
          strategy="lazyOnload"
        />
        <Script
          type="text/javascript"
        ...
        <Script
          type="text/javascript"
          src="/js/footerLinkedin.js"
          strategy="lazyOnload"
        />
        <Script
          type="text/javascript"
          src="/js/footerLinkedinWindow.js"
          strategy="lazyOnload"
        />
        <noscript>
          <img
        ...
        <noscript>
          <img
            ...
            alt="#"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=576246542585612&ev=PageView&noscript=1"
          />
        </noscript>
        <noscript>
          <img
            ...
            alt="#"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=282044725992719&ev=PageView&noscript=1"
          />
        </noscript>
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-WC86N23"
            height="0"
            width="0"
      ...
      <body className="loaded">
        ...
        <noscript>
          <img
            ...
            style={{ display: "none" }}
            alt="#"
            src="https://px.ads.linkedin.com/collect/?pid=74803&fmt=gif"
          />
        </noscript>
      </body>
    </html>
